# Metadata Editor
Unreal Asset Metadata direct editor tool

This tool operates within the Content Browser's right-click context menu on any class of user-selected asset and allows for viewing, editing and saving Metadata key/values.
